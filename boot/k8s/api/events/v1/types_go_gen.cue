...
import (
	metav1 "github.com/defn/m/k8s/apimachinery/pkg/apis/meta/v1"
	corev1 "github.com/defn/m/k8s/api/core/v1"
)
...
// The default event reporter in "github.com/defn/m/k8s/client-go/tools/events/event_broadcaster.go" shows
