{
  inputs = {
    ...
    godev.url = github:defn/m/pkg-godev-0.0.62?dir=pkg/godev
    nodedev.url = github:defn/m/pkg-nodedev-0.0.40?dir=pkg/nodedev
    terraform.url = github:defn/m/pkg-terraform-1.4.4-36?dir=pkg/terraform
    kustomize.url = github:defn/m/pkg-kustomize-5.0.1-36?dir=pkg/kustomize
    helm.url = github:defn/m/pkg-helm-3.11.2-39?dir=pkg/helm
