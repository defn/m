{
  inputs = {
    kubernetes.url = github:defn/m/pkg-kubernetes-0.0.69?dir=pkg/kubernetes
    vault.url = github:defn/m/pkg-vault-1.13.1-36?dir=pkg/vault
    tailscale.url = github:defn/m/pkg-tailscale-1.38.4-10?dir=pkg/tailscale
  };
