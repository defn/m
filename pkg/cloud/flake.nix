{
  inputs = {
    terraform.url = github:defn/m/pkg-terraform-1.4.5-4?dir=pkg/terraform;
    packer.url = github:defn/m/pkg-packer-1.8.6-6?dir=pkg/packer;
    step.url = github:defn/m/pkg-step-0.24.3-4?dir=pkg/step;
