{
  inputs = {
    ...
    kustomize.url = github:defn/m/?dir=pkg/kustomize;
    stern.url = github:defn/m/?dir=pkg/stern;
    argo.url = github:defn/m/pkg-argo-3.4.6-4?dir=pkg/argo;
    argocd.url = github:defn/m/pkg-argocd-2.6.7-4?dir=pkg/argocd;
    tkn.url = github:defn/m/pkg-tkn-0.30.0-2?dir=pkg/tkn;
    kn.url = github:defn/m/pkg-kn-1.9.2-3?dir=pkg/kn;
    vcluster.url = github:defn/m/pkg-vcluster-0.14.2-1?dir=pkg/vcluster;
    kubevirt.url = github:defn/m/?dir=pkg/kubevirt;
  };
